...
description: >
  ...
  or job application strategy. Triggers on: resume review, CV feedback, improve my resume,
  check my resume, resume critique, job application help, ATS optimization, resume tips,
  how to write a summary, what skills to include, how to list work experience, resume
  format, bullet points, action verbs, resume structure, and any other resume-related question.
  Also triggers when the user pastes resume content or shares a resume file (PDF, DOCX, image).
---
...
## Overall Assessment
[2-3 sentence summary of the resume's strengths and biggest areas for improvement]
...
- [Issues that are likely causing rejections, with specific examples from the resume]
...
### Work Experience
[Feedback — this section should get the most detail since it's the most important]
...
## ATS Compatibility
[Assessment of how well the resume would perform in ATS systems]
